...
//Resources* ModuleResources::CreateNewResource(const char* assetsPath, Resource::Type type)
//{
...
//}
//
//Resources* ModuleResources::RequestResource(UID uid)
//{
//	//Find if the resource is already loaded
//	std::map<UID, Resources*>::iterator it = resources.find(uid);
//	if (it != resources.end())
//	{
